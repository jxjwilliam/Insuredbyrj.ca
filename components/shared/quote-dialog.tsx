...
/**
 * Quote dialog component that displays quote request form in a popup
 * Reuses the contact form for quote requests
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto sm:max-w-2xl">
        <DialogHeader>
          <DialogTitle className="text-2xl sm:text-3xl font-bold text-gray-900">
            {t('hero.primaryCTA.text', 'Get Your Free Quote')}
          </DialogTitle>
